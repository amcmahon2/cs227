...
//************************************************************************************
		...
		Board board = new Board(GridUtil.createGrid(testDescription1), GridUtil.findBlocks(testDescription1));
		System.out.println(board.toString());
		System.out.println();
		
		board.grabBlockAtCell(1, 3);
		...
		System.out.println("Location of grab is at (" + board.getGrabbedCell().getRow()
					+ ", " + board.getGrabbedCell().getCol() + ") " + ", expected (1, 3).");
		System.out.println();
		
		board.moveGrabbedBlock(DOWN);
		System.out.println("After moving block down one time game over is " + board.isGameOver()
				+ ", expected is false.");
		System.out.println(board.toString());
		System.out.println();
		/*
